...
TRAIN_MODEL=(
  "checkpoints/1s_5labels_mfccs+densenet/best_model_1s5a.pth"
  "checkpoints/1s_5labels_mfccs+densenet/best_model_1s5b.pth"
  "checkpoints/1s_5labels_mfccs+densenet/best_model_1s5c.pth"
)
ENSEMBLE_WEIGHTS=(0.3 0.66 0.33)  # Ensemble weights for each model, must sum to 1
