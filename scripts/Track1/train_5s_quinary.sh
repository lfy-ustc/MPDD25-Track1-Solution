...
data_rootpath="/data/liufy/MPDD-2025/MPDD-Elderly/" # Dataset root directory
...
BATCH_SIZE=1
LR=0.0000975
# LR=0.00009 # Learning rate, options {9e-5, 1e-4, 2e-4, 3e-4, 5e-4, 1e-3}
# LR=9e-5
NUM_EPOCHS=500
DEVICE="cuda" # Options {cuda, cpu}
MODEL="my_model_pro_dense_lr975" # Model name
CONFIG_PATH="config/config_quinary.json"
